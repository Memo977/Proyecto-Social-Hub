...
class Post extends Model
{
    ...
    public function scopeOfUser($q, $userId) { return $q->where('user_id', $userId); }
    ...
    public function scopePending($q)        { return $q->whereIn('status', ['queued','scheduled']); }
}