        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('posts.queue')" :active="request()->routeIs('posts.queue')">
                        Pendientes
                    </x-nav-link>
                    <x-nav-link :href="route('posts.history')" :active="request()->routeIs('posts.history')">
                        Histórico
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-3">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-300
                                   hover:text-gray-700 dark:hover:text-white focus:outline-none transition">
